...
def main
  encoded = Hex.new('1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736')
  encoded_bytes = encoded.to_bytes
  
  candidates = ('A'..'z').map do |char|
    encoded_bytes.equal_length_xor(Bytes.new([char.ord] * encoded_bytes.length)).to_bytestr
  end.to_a

  best_candidates = candidates.sort_by do |can|
    score_candidate(can).count(true)
  end

  puts best_candidates.last
end
